...
import { Title, Text, Loader, Table, Button, Group, Stack, Paper, Badge, Image, Checkbox, Alert, Modal, ActionIcon, Tooltip } from '@mantine/core';
          ...
          <div className={styles.orderHeader}>
            ...
            <div className={styles.orderWaiting}>
              <DaysElapsed 
                ...
                isFulfilled={order.displayFulfillmentStatus === 'FULFILLED' || false} 
              />
